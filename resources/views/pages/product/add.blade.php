    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Investorlar uchun</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}" style="color: #007bff;">@lang('global.home')</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('products.index') }}" style="color: #007bff;">Investorlar uchun</a></li>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('products.create') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ route('products.index') }}" class="btn btn-light waves-effect float-left">@lang('global.cancel')</a>
                        </div>
                    </form>
